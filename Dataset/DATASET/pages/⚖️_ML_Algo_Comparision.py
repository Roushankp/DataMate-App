...
st.write("NOTE: This model is designed to work with datasets that have a specific structure, particularly where the last column is the target variable (Y) and the rest of the columns are features (X).")
#---------------------------------#
# Model building
def build_model(df):
